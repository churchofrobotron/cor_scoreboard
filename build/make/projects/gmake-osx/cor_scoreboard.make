...
ifeq ($(config),debug)
  ...
  TARGETDIR           = ../../../../scripts/cor_scoreboard.app/Contents/MacOS
  ...
  INCLUDES           += -I"../../../../thirdparty/bx/include/compat/osx" -I"../../../../thirdparty/bx/include" -I"../../../../thirdparty/bimg/include" -I"../../../../thirdparty/bgfx/include" -I"../../../../thirdparty/bgfx/3rdparty" -I"../../../../thirdparty/bgfx/examples/common"
  ...
  ALL_LDFLAGS        += $(LDFLAGS) -L"../../../../thirdparty/bx/scripts" -L"../../../../thirdparty/bimg/scripts" -L"../../../../scripts" -L"../../../../thirdparty/bgfx/scripts" -framework Cocoa -framework QuartzCore -framework OpenGL -weak_framework Metal
  LIBDEPS            += ../../../../thirdparty/bx/scripts/libbxDebug.a ../../../../thirdparty/bimg/scripts/libbimgDebug.a ../../../../thirdparty/bimg/scripts/libbimg_decodeDebug.a ../../../../scripts/libbgfxDebug.a ../../../../thirdparty/bgfx/scripts/libexample-commonDebug.a
  LDDEPS             += ../../../../thirdparty/bx/scripts/libbxDebug.a ../../../../thirdparty/bimg/scripts/libbimgDebug.a ../../../../thirdparty/bimg/scripts/libbimg_decodeDebug.a ../../../../scripts/libbgfxDebug.a ../../../../thirdparty/bgfx/scripts/libexample-commonDebug.a
  LIBS               += $(LDDEPS)
  EXTERNAL_LIBS      +=
  LINKOBJS            = $(OBJECTS)
...
ifeq ($(config),release)
  ...
  ALL_RESFLAGS       += $(RESFLAGS) $(DEFINES) $(INCLUDES)
  ALL_LDFLAGS        += $(LDFLAGS) -L"../../../../thirdparty/bx/scripts" -L"../../../../thirdparty/bimg/scripts" -L"../../../../scripts" -L"../../../../thirdparty/bgfx/scripts" -framework Cocoa -framework QuartzCore -framework OpenGL -weak_framework Metal
  LIBDEPS            += ../../../../thirdparty/bx/scripts/libbxRelease.a ../../../../thirdparty/bimg/scripts/libbimgRelease.a ../../../../thirdparty/bimg/scripts/libbimg_decodeRelease.a ../../../../scripts/libbgfxRelease.a ../../../../thirdparty/bgfx/scripts/libexample-commonRelease.a
  LDDEPS             += ../../../../thirdparty/bx/scripts/libbxRelease.a ../../../../thirdparty/bimg/scripts/libbimgRelease.a ../../../../thirdparty/bimg/scripts/libbimg_decodeRelease.a ../../../../scripts/libbgfxRelease.a ../../../../thirdparty/bgfx/scripts/libexample-commonRelease.a
  LIBS               += $(LDDEPS)
  EXTERNAL_LIBS      +=
  LINKOBJS            = $(OBJECTS)
  LINKCMD             = $(CXX) -o $(TARGET) $(LINKOBJS) $(RESOURCES) $(ARCH) $(ALL_LDFLAGS) $(LIBS)
