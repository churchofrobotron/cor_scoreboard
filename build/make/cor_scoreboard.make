...
ifeq ($(config),debug)
  ...
  TARGETDIR           = ../bin/cor_scoreboard.app/Contents/MacOS
  ...
  ALL_LDFLAGS        += $(LDFLAGS) -L"../bin" -framework Cocoa -framework QuartzCore -framework OpenGL -weak_framework Metal
  LIBDEPS            += ../bin/libbxDebug.a ../bin/libbimgDebug.a ../bin/libbimg_decodeDebug.a ../bin/libbgfxDebug.a ../bin/libexample-commonDebug.a
  LDDEPS             += ../bin/libbxDebug.a ../bin/libbimgDebug.a ../bin/libbimg_decodeDebug.a ../bin/libbgfxDebug.a ../bin/libexample-commonDebug.a
  LIBS               += $(LDDEPS)
  EXTERNAL_LIBS      +=
  LINKOBJS            = $(OBJECTS)
...
ifeq ($(config),release)
  ...
  ALL_RESFLAGS       += $(RESFLAGS) $(DEFINES) $(INCLUDES)
  ALL_LDFLAGS        += $(LDFLAGS) -L"../bin" -framework Cocoa -framework QuartzCore -framework OpenGL -weak_framework Metal
  LIBDEPS            += ../bin/libbxRelease.a ../bin/libbimgRelease.a ../bin/libbimg_decodeRelease.a ../bin/libbgfxRelease.a ../bin/libexample-commonRelease.a
  LDDEPS             += ../bin/libbxRelease.a ../bin/libbimgRelease.a ../bin/libbimg_decodeRelease.a ../bin/libbgfxRelease.a ../bin/libexample-commonRelease.a
  LIBS               += $(LDDEPS)
  EXTERNAL_LIBS      +=
  LINKOBJS            = $(OBJECTS)
  LINKCMD             = $(CXX) -o $(TARGET) $(LINKOBJS) $(RESOURCES) $(ARCH) $(ALL_LDFLAGS) $(LIBS)
